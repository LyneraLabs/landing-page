              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-xl text-gray-300 mb-6">
                    Our flagship engineering platform that revolutionizes software development workflows
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-white font-semibold">Advanced Engineering Tools</h4>
                        <p className="text-gray-400 text-sm">Comprehensive toolkit for modern development</p>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <a
                      href="https://github.com/ZachG05/new-engx"
                      target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-purple-900/20 to-violet-900/10 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Future Product</h3>
              <p className="text-gray-400 mb-4">
                Exciting new solutions in development. Stay tuned for announcements!
              </p>
